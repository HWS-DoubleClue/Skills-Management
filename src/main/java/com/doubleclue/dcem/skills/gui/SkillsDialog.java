...
public class SkillsDialog extends DcemDialog {
	...
	public boolean actionOk() throws Exception {
		...
		if (action.equals(DcemConstants.ACTION_ADD)) {
			skillsEntity.setStatus(ApprovalStatus.APPROVED);
		}
	...
	public void show(DcemView dcemView, AutoViewAction autoViewAction) throws Exception {
		...
		if (action.equals(SkillsConstants.REQUEST_SKILLS)) {
			...
			skillsEntity.setStatus(ApprovalStatus.PENDING);
		}
	...
	public boolean isSkillsPending() {
		...
		return ApprovalStatus.PENDING.equals(skillsEntity.getStatus());
	}

	public String getSkillsStatus(SkillsEntity skillsEntity) {
		if (skillsEntity == null || skillsEntity.getStatus() == null) {
			return "-";
		} else {
			return skillsEntity.getStatus().getLocaleText();
		}
	}
	...
	public void actionApproveSkill() {
		skillsEntity.setStatus(ApprovalStatus.APPROVED);
		skillsEntity.setRequestedFrom(null);
	}
